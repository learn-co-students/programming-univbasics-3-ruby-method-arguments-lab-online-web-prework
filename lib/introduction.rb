...
# in order to complete the rest of this course and be ready for the next  
#introduction(chris)
# puts "hi, my name is (chris)."
#end
#def introduction_with_language(chris, language)
# puts "hi, my name is # {chris} and i am learning to program in #(english)."
#end
