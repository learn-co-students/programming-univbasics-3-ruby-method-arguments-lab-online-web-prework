...
# in order to complete the rest of this course and be ready for the next cour
name = "Jackson"
...
introduction_with_language("Jackson", "Ruby")

def introduction_with_language_optional(name, language = "Ruby")
  puts "Hi, my name is #{name} and I am learning to program in #{language}."
end

introduction_with_language_optional("Jackson")
